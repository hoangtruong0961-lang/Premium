...
const GameInput = forwardRef<GameInputRef, GameInputProps>(({
    ...
    return (
        <div className="w-full flex flex-col gap-2">
            ...
            {/* Input Bar */}
            <div className="p-1.5 md:p-2.5 flex flex-col gap-2.5 border-t border-[#cbd2df]/20 dark:border-[#142042]/10 bg-[#e6ebf4] dark:bg-[#0b1329] backdrop-blur-sm shadow-inner">
                {/* Top Row: Input Area */}
                        ...
                        >
                            <div className="relative w-full group">
                                <textarea 
                                    ...
                                    className="w-full bg-[#e6ebf4] dark:bg-[#0b1329] neu-sm-inset font-sans rounded-2xl p-3 pb-14 text-slate-800 dark:text-slate-200 border-none outline-none focus:text-mystic-accent transition-all resize-none h-20 md:h-28 custom-scrollbar text-sm md:text-base shadow-inner"
                                />
