    ...
    return (
        <AnimatePresence>
            {show && (
                <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/80 backdrop-blur-sm p-2 md:p-4 pointer-events-auto">
                    <motion.div
                        ...
                        className="relative bg-stone-200 dark:bg-mystic-950 border border-stone-400 dark:border-slate-800 rounded-xl shadow-2xl overflow-hidden flex flex-col animate-presence w-[98%] max-w-[1400px] h-[94%] md:h-[98%]"
                    >
                        {content}
                    </motion.div>
                </div>
            ...
            {showImportExport && (
                <div className="fixed inset-0 z-[170] flex items-center justify-center bg-black/85 backdrop-blur-sm p-4">
                    <div 
                        className="bg-stone-250 dark:bg-mystic-900 border border-stone-400 dark:border-slate-800 rounded-xl shadow-2xl p-5 space-y-4 w-[92%] max-w-lg max-h-[85%] overflow-y-auto"
                    >
                        <div className="flex justify-between items-center pb-2 border-b border-stone-300 dark:border-slate-800">
                            <div className="flex items-center gap-2 text-mystic-accent">
                                <FileDown size={18} />
